...
public class GameClient {
    ...
    @Autowired
    private BackendController myBackendCtrl;
    ...
    public GameClient(String serverAddress) throws Exception {
        Map<String, Characters> initAssignments = myBackendCtrl.getInitAssignments();
        for (String player : initAssignments.keySet()) {
            Card card = new Card(player, initAssignments.get(player));
            playerCards.put(player, card);
        }

        Characters[] initMiddleCards = myBackendCtrl.getMiddleCards();
